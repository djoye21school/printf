...
int main()
{
	printf("%d\n", ft_printf("{%f}{%lf}{%Lf}", 1444565444646.6465424242242, 1444565444646.646542424224, 1444565444646.646542424224));
	printf("\n");
	printf("%d\n", printf("{%f}{%lf}{%Lf}", 1444565444646.6465424242242, 1444565444646.646542424224, 1444565444646.646542424224));
	return (0);
}